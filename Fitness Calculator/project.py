...
def main():
 ...
 name=str(E1.get())
 L00 = Label(top1, text=name +" Your Medical Report is:",fg="brown",font="Times").grid(row=0,column=0)
 ...
 E122=Entry(top1,bd=5)
 E122.grid(row=1,column=2)
 weight1=int(E3.get())
 ...
 E12['bg']='orange'
 if (bmi1<18.5):
  E122.insert(0,"Underweight")
  E122['bg']='red'
 elif (bmi1>=18.5 and bmi1<=24.9):
  E122.insert(0,"Normal")
  E122['bg']='yellow'
 elif (bmi1>=25.0 and bmi1<=29.9):
  E122.insert(0,"Overweight")
  E122['bg']='grey' 
 else:
  E122.insert(0,"Very Overweight")
  E122['bg']='green'
 
 """____________________BP____________________"""
 L11=Label(top1,text="BP(HIGH/NORMAL/LOW):",fg="red")
 ...
 L22=Label(top1,text="Pulse Rate(HIGH/NORMAL/LOW):",fg="red")
 ...
 L33=Label(top1,text="RBC Count(HIGH/NORMAL/LOW):",fg="red")
 ...
 L44=Label(top1,text="WBC Count(HIGH/NORMAL/LOW):",fg="red")
 ...
 L55=Label(top1,text="Platelets(HIGH/NORMAL/LOW):",fg="red")
 ...
 L66=Label(top1,text="HB(HIGH/NORMAL/LOW):",fg="red")
 ...
 L77=Label(top1,text="Uric Acid(HIGH/NORMAL/LOW):",fg="red")
 ...
 L88=Label(top1,text="Cholestrol(HIGH/NORMAL/LOW):",fg="red")
...
top = Tk()
L0 = Label(top, text="Fitness Calculator",fg="purple",font="Times").grid(row=0,column=1)
L1=Label(top,text="Name",fg="red",font="Times").grid(row=1,column=0)
E1= Entry(top,bd=5)
E1.grid(row=1,column=1)
L2=Label(top,text="age ",fg="red",font="Times").grid(row=2,column=0)
E2= Entry(top,bd=5)
...
L6=Label(top,text="Pulserate (0-100)",fg="red",font="Times").grid(row=6,column=0)
E6=Entry(top,bd=5)
E6.grid(row=6,column=1)
L7=Label(top,text="RBCcount ( 310000-610000)",fg="red",font="Times").grid(row=7,column=0)
E7 = Entry(top,bd=5)
E7.grid(row=7,column=1)
L8=Label(top,text="WBCcount (2000-10000)",fg="red",font="Times").grid(row=8,column=0)
E8= Entry(top,bd=5)
E8.grid(row=8,column=1)
L9=Label(top,text="Platelets (150000-615000)",fg="red",font="Times").grid(row=10,column=0)
E9 = Entry(top,bd=5)
E9.grid(row=10,column=1)
L10=Label(top,text="HEMOGLOBIN(0-16)",fg="red",font="Times").grid(row=11,column=0)
E10 = Entry(top,bd=5)
E10.grid(row=11,column=1)
L50=Label(top,text="URIC ACID (0-7)",fg="red",font="Times").grid(row=12,column=0)
E50 = Entry(top,bd=5)
E50.grid(row=12,column=1)
L51=Label(top,text="CHOLESTROL(40-55)",fg="red",font="Times").grid(row=13,column=0)
E51 = Entry(top,bd=5)
...
D1=Label(top,text="Rashmi Kumari",fg='brown')
D1.grid(row=19,column=1)
D2=Label(top,text="Jaspreet Singh",fg='red')
D2.grid(row=19,column=2)
D2=Label(top,text="Puneet",fg='black')
D2.grid(row=19,column=3)
B14=Button(top, text='RESET ALL ENTRIES',command=clear_textbox,bg="cyan")
